...
import { ChevronRightIcon, SettingsIcon, KanbanIcon, ChartColumnIcon, CalendarIcon, ArrowRightIcon, NotebookIcon, BookMarkedIcon } from 'lucide-react';
...
const ProjectSidebar = () => {
    ...
    const getProjectSubItems = (projectId) => [
        ...
        { title: 'Notes',icon: NotebookIcon,url: `/projectsDetail?id=${projectId}&tab=notes` },
        { title: 'Bookmark',icon: BookMarkedIcon,url: `/projectsDetail?id=${projectId}&tab=bookmark` },
